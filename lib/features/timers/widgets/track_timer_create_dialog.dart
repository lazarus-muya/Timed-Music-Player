...
class _TrackTimerCreateDialogState extends ConsumerState<TrackTimerCreateDialog> {
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () async {
                ...
                if (time != null) {
                  if (!_isEndTimeBeforeStartTime(_selectedStartTime, time)) {
                    setState(() {
            ...
            Consumer(
              builder: (context, ref, child) {
                ...
                return playlistsAsync.when(
                  data: (playlists) => DropdownButton<String>(
                  ...
                  child: TextButton(
                    onPressed: () {
                      if (widget.nameController.text.isNotEmpty &&
                          ...
                          !_isEndTimeBeforeStartTime(_selectedStartTime, _selectedEndTime)) {
                        ...
                        } else if (_isEndTimeBeforeStartTime(_selectedStartTime, _selectedEndTime)) {
